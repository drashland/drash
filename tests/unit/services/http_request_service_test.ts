...
members.testSuite("services/http_request_service_test.ts | getRequestBodyParam()", () => {
...
members.testSuite("services/http_request_service_test.ts | getRequestHeaderParam()", () => {
...
members.testSuite("services/http_request_service_test.ts | getRequestPathParam()", () => {
  members.test("Returns the value for the header param when it exists", async () => {
...
members.testSuite("services/http_request_service_test.ts | getRequestUrlQueryParam()", () => {
...
members.testSuite("services/http_request_service_test.ts | getResponseContentType()", () => {
  ...
  members.test("Returns text/plain when specified in the query", async () => {
    let request = members.mockRequest("/something?response_content_type=text/plain");
    request = await service.hydrate(request);
    const contentType = service.getResponseContentType(request);
    members.assertEquals(contentType, "text/plain")
  })
...
members.testSuite("services/http_request_service_test.ts | getUrlPath()", () => {
...
members.testSuite("services/http_request_service_test.ts | getUrlQueryParams()", () => {
...
members.testSuite("services/http_request_service_test.ts | getUrlQueryString()", () => {
...
members.testSuite("services/http_request_service_test.ts | hydrate()", () => {
  ...
  members.test("Sets the headers on the request when passed in", async () => {
    ...
    members.assertEquals(request.headers.get("cookie"), "test_cookie=test_cookie_val")
  });
  ...
  members.test("Attaches the url query params", async () => {
    let request = members.mockRequest("/users?name=Edward&age=not_telling", "get");
    request = await service.hydrate(request)
...
members.testSuite("services/http_request_service_test.ts | parseBodyAsJson()", () => {
...
members.testSuite("services/http_request_service_test.ts | setHeaders()", async () => {
  ...
  members.test("Attaches headers to the request object", async () => {
    ...
    members.assertEquals(request.headers.get("Content-Type"), "application/json")
  });
