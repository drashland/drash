...
Apart from the entry point and the server call, this is identical to the [Deno guide](/quickstart/deno) — both pass a Web `Request` straight through and return a Web `Response`.
