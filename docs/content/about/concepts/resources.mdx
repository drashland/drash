...
Like the [MDN](https://developer.mozilla.org/en-US/docs/Web/HTTP/Guides/Overview) and [RFC](https://datatracker.ietf.org/doc/html/rfc7231/#section-2), a resource in Drash is the target of an HTTP request. In Drash, resources are represented as classes with [pathnames](https://developer.mozilla.org/en-US/docs/Web/API/URL/pathname) (aka __paths__) and [HTTP request methods](https://developer.mozilla.org/en-US/docs/Web/HTTP/Methods):
...
**We (the authors) prefer classes when processing resources internally.**
...
<CodeTabs
  ...
  files={["MyResource.js", "MyResource.ts", "MyResource.ts", "MyResource.js"]}
>
<CodeTab>
...
```ts
import { Resource } from "npm:@drashland/drash/modules/http.native.js";
