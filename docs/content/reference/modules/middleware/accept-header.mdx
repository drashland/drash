...
import { AcceptHeader } from "@drashland/drash/modules/middleware/AcceptHeader/mod.js";
...
Like the other bundled middleware, `AcceptHeader` is a __factory__. Calling it
...
```typescript showLineNumbers
import { AcceptHeaderMiddleware } from "@drashland/drash/modules/middleware/AcceptHeader/mod.js";
