...
This list is not exhaustive and is not meant to be. It covers the headers the pre-built middleware read and write &mdash; [CORS](/reference/modules/middleware/cors), [ETag](/reference/modules/middleware/etag), and [RateLimiter](/reference/modules/middleware/rate-limiter). Any other header name is a plain string.
