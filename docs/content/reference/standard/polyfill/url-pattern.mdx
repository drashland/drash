...
Both entry points call `.urlPatternClass()` for you. Calling it yourself overrides whatever the entry point injected — see [Native vs. Polyfill](/reference/modules/native-vs-polyfill).
