...
`Middleware` extends [`Resource`](/reference/core/http/resource). It is a decorator, not a separate concept — which is why it has the same nine HTTP methods and can stand in for the resource it wraps.
...
See the [Middleware tutorial](/docs/tutorials/middleware) for writing them and [Grouping Resources](/docs/resources/grouping-resources) for attaching them.
