...
Chains are modules that implement the [Chain of Responsibility](https://en.wikipedia.org/wiki/Chain-of-responsibility_pattern) pattern. Chains are explained on the [Concepts > Chains](/concepts/chains) page.
...
[Native vs. polyfill](/concepts/native-vs-polyfill) covers which one to pick and how to supply your own `URLPattern`.
...
Read about [chains](/concepts/chains) and how you can use one to create an application.
