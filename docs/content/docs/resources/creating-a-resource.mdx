...
**Every method you do not define throws a `501 Not Implemented` error response.** That is the base class' default behavior, following [RFC 7231 Section 4.1](https://datatracker.ietf.org/doc/html/rfc7231#section-4.1).
