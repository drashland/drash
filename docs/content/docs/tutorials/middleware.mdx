...
Via a [resource group](/reference/standard/resource-group):
...
Four middleware ship with Drash. Each is documented with its options, defaults,
and exports under Reference:
...
They are ordinary middleware — each is a class you pass to `.middleware()`, and
