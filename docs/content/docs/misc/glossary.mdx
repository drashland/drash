...
This page (inspired by [MDN Web Docs Glossary](https://developer.mozilla.org/en-US/docs/Glossary)) contains the definitions of the terms and acronyms we use.
...
The object you build with `Application.builder()`. It receives requests, routes
them to your [resources](#resource), and returns what they produce.

Under the hood it is an HTTP request chain &mdash; see [Chain](#chain) &mdash; but "application" is
what you are building, so that is the name the HTTP module exposes.
...
A builder is explained on the [About > Concepts > Builders](/about/concepts/builders) page.
...
A chain is explained on the [About > Concepts > Chains](/about/concepts/chains) page.
...
The paths defined in a resource class' `paths` property. These paths have the same definition as the [`URL.pathname`](https://developer.mozilla.org/en-US/docs/Web/API/URL/pathname) property.
...
We define this the same as [MDN > Protocol](https://developer.mozilla.org/en-US/docs/Glossary/Protocol).

> A protocol is a system of rules that define how data is exchanged within or between computers. Communications between devices require that the devices agree on the format of the data that is being exchanged. The set of rules that defines a format is called a protocol.

### Request

This is an alias for [HTTP Request](https://developer.mozilla.org/en-US/docs/Web/HTTP/Messages#http_requests).

### Resource

Resources are explained on the [About > Concepts > Resources](/about/concepts/resources) page.
...
This is an alias for [TL;DR](https://www.merriam-webster.com/dictionary/TL%3BDR), but without the semicolon.
