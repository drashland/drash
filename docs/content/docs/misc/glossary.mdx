...
A builder is explained on the [Builders](/docs/concepts/builders) page.
...
A chain is explained on the [Chains](/docs/concepts/chains) page.
...
Resources are explained on the [Resources](/docs/concepts/resources) page.
