...
- [Apply your middleware](/docs/middleware#applying-middleware) to a group of resources.
- Browse the [pre-built middleware](/docs/middleware#pre-built-middleware) Drash ships.
