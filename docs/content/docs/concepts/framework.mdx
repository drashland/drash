...
Chains are modules that implement the [Chain of Responsibility](https://en.wikipedia.org/wiki/Chain-of-responsibility_pattern) pattern. Chains are explained on the [Concepts > Chains](/docs/concepts/chains) page.
