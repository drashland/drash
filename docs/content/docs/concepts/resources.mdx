...
For the full API — what the methods receive, what happens to the ones you leave out, and how to read params — see [Creating a Resource](/docs/resources/creating-a-resource).
...
- [Creating a Resource](/docs/resources/creating-a-resource) for paths, params, and dynamic path syntax.
