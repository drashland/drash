...
Retrieve them via [`request.params`](/docs/tutorials/resource#request-params), and see [Dynamic paths](/docs/tutorials/resource#dynamic-paths) for the full syntax.
