...
When you build HTTP applications with Drash, you start by creating a chain (specifically the HTTP module's [Chain](/reference/modules/http-native)). From there, you give it [resources](/docs/concepts/resources) — the classes you use to process requests and respond to them.
