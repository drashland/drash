...
| [Concepts](/docs/concepts/framework)             | The framework's shape, the request chain, resources, builders, and the native/polyfill modules |
...
- why [builders](/docs/concepts/builders) assemble your application; and
...
- [Create a tiny HTTP application](/docs/getting-started/step-by-step-guide) using the HTTP module's `Application` class.
