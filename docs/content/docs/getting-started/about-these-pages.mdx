...
Although Drash has zero dependencies — meaning you could run it in the browser, these pages are written assuming you are using Drash to build server-side HTTP applications. Pages discussing how to build applications in the browser will be written at a later time.
...
| ---------------------------------------------------- | ---------------------------------------------------------------------------------- |
| [Getting Started](/docs/getting-started) | What Drash is, and what you need installed before you begin                          |
| [Quickstart](/docs/quickstart)                       | A complete app per runtime                                                           |
| [Concepts](/docs/concepts/framework)                 | The framework's shape, the request chain, resources, and the native/polyfill modules   |
| [Tutorials](/docs/tutorials/step-by-step-guide)            | Building an app in steps and working with resources                             |
| [Middleware](/docs/middleware)                       | Using pre-built middleware and writing your own       |
...
- how [chains](/docs/concepts/chains) work under the hood;
- how [resources](/docs/concepts/resources) play a role in the chains; and
...
| **Next Steps**   | Our recommendations on what to do next. Follow them or navigate the pages at your leisure.                                                                   |
...
- Follow the [prerequisites](/docs/getting-started/prerequisites) to set up your local environment.

### Want to jump ahead?

- [Create a tiny HTTP application](/docs/tutorials/step-by-step-guide) using the HTTP module's `Chain` class.
