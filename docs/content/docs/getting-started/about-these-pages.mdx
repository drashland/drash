...
| [Tutorials](/docs/tutorials/middleware)          | Using pre-built middleware, writing your own, and handling errors                    |
...
- how [resources](/docs/concepts/resources) play a role in the chains;
