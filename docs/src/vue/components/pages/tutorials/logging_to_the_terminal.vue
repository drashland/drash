        ...
        ol
            ...
            li A resource class named <code>HomeResource</code> is created.
                ul
                    ...
                    li <code>HomeResource</code> contains a <code>GET()</code> method. This method will handle all <code>GET</code> requests to <code>HomeResource</code>. When a client makes a <code>GET</code> request to <code>HomeResource</code>, log messages will be written to the terminal.
...
export const resource = {
    paths: ["/tutorials/logging-to-the-terminal"],
    meta: {
        title: "Logging: Logging To The Terminal",
        tutorial_title: "Logging To The Terminal",
        source_code_uri: "/tutorials/logging_to_the_terminal"
    }
}
...
export default {
    data() {
        return {
            data: {
                example_code: this.$app_data.example_code['/docs/src/example_code/tutorials/logging_to_the_terminal']
            }
        };
    },
}
