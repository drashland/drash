...
export const resource = {
    paths: ["/advanced-tutorials/creating-a-web-app/hello-world/part-3"],
    meta: {
...
export default {
    data() {
        return {
            data: {
                example_code: this.$app_data.example_code['/docs/src/example_code/advanced_tutorials/creating_a_web_app/hello_world/part_3'],
            }
        };
    },
}
