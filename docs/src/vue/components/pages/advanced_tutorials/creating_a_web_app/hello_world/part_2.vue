...
page-creating-an-app-hello-world(:data="data")
    ...
    template(v-slot:screenshot)
        ...
        div.row
            div.col
                a.btn.btn-success(:href="$conf.base_url + '/#/tutorials/creating-an-app-hello-world-part-1'") Go to Part 1
            div.col.text-right
...
export const resource = {
    paths: ["/advanced-tutorials/creating-a-web-app/hello-world/part-2"],
    meta: {
        title: "Creating An App: Hello World Part 2 of 4: Building The Front End",
        tutorial_title: "Part 2 of 4: Building The Front End",
...
export default {
    data() {
        return {
            data: {
                example_code: this.$app_data.example_code['/docs/src/example_code/advanced_tutorials/creating_a_web_app/hello_world/part_2'],
            }
        };
    },
}
