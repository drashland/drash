...
export const resource = {
    paths: ["/advanced-tutorials/creating-a-web-app/hello-world/part-4"],
    meta: {
        title: "Creating An App: Hello World Part 4 of 4: Logging",
        tutorial_title: "Part 4 of 4: Logging",
        source_code_uri: "/creating_a_web_app/hello_world/part_4"
    }
}
...
export default {
    data() {
        return {
            data: {
                example_code: this.$app_data.example_code['/docs/src/example_code/advanced_tutorials/creating_a_web_app/hello_world/part_4'],
                hide_snapshot: true
            }
        };
    },
