...
exports.ErrorHandlerProxy = void 0;
const error_handler_js_1 = require("../handlers/error_handler.js");
...
class ErrorHandlerProxy {
  ...
  constructor(ErrorHandlerClass) {
     ...
     */
    _ErrorHandlerProxy_fallback.set(
      this,
      new error_handler_js_1.ErrorHandler(),
    );
...
exports.ErrorHandlerProxy = ErrorHandlerProxy;
