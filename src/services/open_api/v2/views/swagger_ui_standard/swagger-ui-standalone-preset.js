...
!function (t, e) {
  ...
  return function (t) {
      ...
      t.exports = function () {
        ...
        J.prototype[tt] = !0,
          ...
          Lt.prototype.slice = function (t, e) {
            return I(t, e, this.size) ? this
            : (t = O(t, this.size),
              (e = A(e, this.size)) <= t ? new Lt(0, 0) : new Lt(
        ...
        function ge(t) {
          return t = (t = (858993459 & (t -= t >> 1 & 1431655765)) +
    ...
    function (t, e, n) {
      ...
      function nt(t) {
        var e;
        return 48 <= t && t <= 57 ? t - 48 : 97 <= (e = 32 | t) && e <= 102
          ? e - 97 + 10
          : -1;
      }
      function rt(t) {
      ...
      for (
        var ot = new Array(256), ut = new Array(256), st = 0;
        st < 256;
        st++
      ) {
      ...
      function xt(t, e, n, r, o) {
        ...
        if (
          null !== t.listener && t.listener("open", t),
            ...
            r && gt(t, !0, -1) &&
            (v = !0,
              t.lineIndent > e ? y = 1 : t.lineIndent === e
                ? y = 0
                : t.lineIndent < e && (y = -1)),
            1 === y
        ) {
      ...
      function Et(t) {
        this.schema = t.schema || G,
          ...
          this.flowLevel = i.isNothing(t.flowLevel)
            ? -1
            : t.flowLevel,
          ...
          this.replacer = "function" == typeof t.replacer
            ? t.replacer
            : null,
          this.implicitTypes = this.schema.compiledImplicit,
      ...
      function Rt(t, e, n) {
        var r = Pt(t), i = r && !Ut(t);
        return (n ? r : r && 44 !== t && 91 !== t && 93 !== t && 123 !== t &&
              125 !== t) && 35 !== t && !(58 === e && !i) ||
    ...
    function (t, e, n) {
      ...
      Object.defineProperty(s, "defaultMaxListeners", {
        ...
        s.prototype.removeListener = function (t, e) {
          ...
          if (n === e || n.listener === e) {
            0 == --this._eventsCount ? this._events = Object.create(null)
            : (delete r[t],
              r.removeListener &&
      ...
      (function (e, r) {
        ...
        Object.defineProperty(M.prototype, "destroyed", {
          ...
          M.prototype.push = function (t, e) {
            ...
            return r.objectMode ? n = !0 : "string" == typeof t &&
        ...
        function A(t, e) {
          return 0 === e.length ? null : (e.objectMode
            ? n = e.buffer.shift()
            : !t || t >= e.length
            ? (n = e.decoder
              ? e.buffer.join("")
        ...
        M.prototype.read = function (t) {
          ...
          return h("need readable", i),
            ...
            e.ended || e.reading ? h("reading or ended", i = !1) : i &&
              (h("do read"),
                e.reading = !0,
                e.sync = !0,
    ...
    function (t, e, n) {
      ...
      r({ target: "Array", proto: !0, forced: !y }, {
        slice: function (t, e) {
          ...
          for (
            r = new (void 0 === n ? g : n)(w(M - y, 0)), i = 0;
            y < M;
            y++, i++
          ) {
            y in p && l(r, i, p[y]);
    ...
    function (t, e, n) {
      ...
      t.exports = !p || u(function () {
        ...
        ? function (t, e) {
          for (
            var n = f(t), i = arguments.length, u = 1, p = a.f, h = c.f;
            i > u;
          ) {
            for (
              var y,
      ...
      t.exports = function (t, e) {
        return function (n, c) {
          ...
          return n = Object(i(n)),
            ...
            f = s(n),
            p && f.sort(
              "function" == typeof p ? o.call(p, n) : void 0,
            ),
      ...
      a.maxAge = function (t, e, n) {
        ...
        (t = s(t)) &&
          (h = p(null),
            ...
            n.preFetch &&
            (y = !0 === n.preFetch || isNaN(n.preFetch) ? .333
