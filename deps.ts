...
import { STATUS_TEXT as StdStatusText } from "https://deno.land/std@0.149.0/http/http_status.ts";
...
export type { Cookie } from "https://deno.land/std@0.149.0/http/cookie.ts";
